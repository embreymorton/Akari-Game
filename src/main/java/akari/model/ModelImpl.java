...
public class ModelImpl implements Model {
  ...
  private List<Lamp> currentLamps;
  ...
  public ModelImpl(PuzzleLibrary library) {
    ...
    for (int i = 0; i < library.size(); i++) {
      lampList.add(new ArrayList<>());
    }
    currentLamps = lampList.get(0);
  }
  ...
  public void addLamp(int r, int c) {
    ...
    if (!isLamp(r, c)) currentLamps.add(new Lamp(r, c));
    updateObservers();
  }
  ...
  public void removeLamp(int r, int c) {
    ...
    if (isLamp(r, c)) currentLamps.remove(currentLamp);
    updateObservers();
  }
  ...
  public void setActivePuzzleIndex(int index) {
    ...
    this.index = index;
    activePuzzle = library.getPuzzle(index);
    currentLamps = lampList.get(index);
    updateObservers();
  }
